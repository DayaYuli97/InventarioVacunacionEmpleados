...
public class EmployeesController {
     ...
     * @return EmployeesVO.
     */
    @GetMapping("/loginEmployees")
    public EmployeesVO loginEmployees(@RequestParam("usser") String usser, @RequestParam("pass")String pass ) {
        return service.loginEmployees(usser, pass);
    }
